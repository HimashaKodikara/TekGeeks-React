...
export default function UserList() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      {/* Header section with Search and Sort toggle */}
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="mt-4 text-gray-500 font-medium">Loading amazing users...</p>
        </div>
      )}
      ...
      {error && !loading && (
        <div className="rounded-xl bg-red-50 p-6 text-center ring-1 ring-red-100 shadow-sm max-w-2xl mx-auto">
          ...
          <h3 className="mt-2 text-lg font-bold text-red-800">Oops! Something went wrong</h3>
        ...
        <>
          {filteredAndSortedUsers.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="mt-2 text-gray-500">We couldn't find anyone matching "{searchQuery}"</p>
            </div>
          )}
        </>
      )}
